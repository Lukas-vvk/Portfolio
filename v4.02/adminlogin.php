...
<main class="main_page" lang="en">
    ...
    <div class="login-cont container mt-5" id="signInForm">
        <div class="hello-msg text-center">
            <h1 class="logh1">Sveiki administratoriau!</h1>
            <h3 class="sign-in-text mb-4">Galite prisijungti prie savo paskyros ir tvarkyti turinį</h3>
            <a href="prisijungti.php" id="signUpLink">Paprastas prisijungimas</a></span>
        </div>
        <br>
        <form action="adminbaze.php" method="post">
            <div class="container">
