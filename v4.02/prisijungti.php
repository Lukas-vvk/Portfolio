...
<main class="main_page" lang="en">
    ...
    <div class="login-cont container mt-5" id="signInForm">
        <div class="hello-msg text-center">
            <h1 class="logh1">Sveiki sugrįžę!</h1>
            <h3 class="sign-in-text mb-4">Galite prisijungti prie savo paskyros</h3>
            Dar neturite paskyros?
            <a href="registracija.php" id="signUpLink">Prisiregistruokite</a></span>
        </div>
        <br>
        <form action="login.php" method="post">
            <div class="container">
                <label for="email">El. paštas:</label><br>
                <input type="email" placeholder="Įveskite El. paštą" id="email" name="email" required><br>
                <label for="password">Slaptažodis:</label><br>
                <input type="password" placeholder="Įveskite slaptažodį" id="password" name="password" required><br><br>
                
                <button class="btn-new" type="submit" name="signin">Prisijungti</button>
            </div>
        </form>
        <div class="hello-msg text-center"><br>
        Administratoriaus <a href="adminlogin.php">prisijungimas</a>
        </div>
    </div>
</main>
<br><br><br>
